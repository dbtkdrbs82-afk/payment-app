...
async function renderBeautyHoursMobile() {
                ...
                return `
                  ...
                  >
                    ...
                    >
                      ...
                      <select
                        class="beauty-mobile-hours-open"
                        ${
                          isClosed ||
                          is24Hours
                            ? 'disabled'
                      ...
                      <select
                        class="beauty-mobile-hours-close"
                        ${
                          isClosed ||
                          is24Hours
                            ? 'disabled'
                    ...
                    >
                      ...
                      >
                        ...
                        <input
                          class="beauty-mobile-hours-closed"
                          type="checkbox"
                          ${
                            isClosed
                              ? 'checked'
      ...
      (row) => {
        ...
        const openSelect =
          row.querySelector<HTMLSelectElement>(
            '.beauty-mobile-hours-open'
          )

        const closeSelect =
          row.querySelector<HTMLSelectElement>(
            '.beauty-mobile-hours-close'
          )

        const closedCheckbox =
          row.querySelector<HTMLInputElement>(
            '.beauty-mobile-hours-closed'
          )

        const hours24Checkbox =
          row.querySelector<HTMLInputElement>(
            '.beauty-mobile-hours-24'
          )
...
>
        ...
        <div
          class="beauty-mobile-order-summary-grid"
        >

          <div
            class="merchant-mobile-order-summary-card"
          >
                    ...
                    (
                      ...
                      if (
                        ...
                        actionHtml = `
                          <button
                            type="button"
                            class="hotel-staff-order-complete"
                            data-id="${order.id}"
                            style="
                              width:100%;
                              margin-top:14px;
  ...
  document
    ...
    ?.addEventListener(
      ...
      () => {
        ...
        location.href =
          '/merchant-app/hotel/orders?date=' +
          moveDate(-1)
      }
    )
